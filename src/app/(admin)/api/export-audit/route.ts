...
export async function GET(req: NextRequest) {
  ...
  // Join through employees — public.users has no full_name/email columns.
  ...
  // 3b. Resolve entity names per entity_type
  ...
  // entityName shows human-readable name; UUID ישות keeps raw ID for debugging
  worksheet.columns = [
    ...
    { header: 'ישות',         key: 'entityName',  width: 30 },
    { header: 'UUID ישות',    key: 'entity_id',   width: 38 },
