...
// Admin interface is Sharon-only — no module-level permission enforcement here.
// Permission infrastructure (requirePermission, getNavPermissions) is reserved
// for future ChemoSys module pages, not for this admin shell.
//
